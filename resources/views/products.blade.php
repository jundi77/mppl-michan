...
<head>
    ...
    <title>Produk - Michan Hijab</title>
              ...
              <div class="form-row justify-content-end">
                <div class="form-group col-md-3">
                    <select class="custom-select mr-sm-2 form-control" >
                      <option class="disable">Category</option>
                      <option>Gamis Dewasa</option>
                      <option>Koko Dewasa</option>
                      <option>Michan Kids</option>
                    </select>
                  </div>

               <div class="form-group col-md-3">
                <select class="custom-select mr-sm-2 form-control">
                    <option class="disable">Urutkan</option>
                        ...
                        <a href="./product-detail.html" class="page-products d-block">
                            <div class="products-thumbnail">
                                <div 
                                  ...
                                  style="background-image: url(/reg/images/pictures/dhira-dress.jpg);">
                                </div>
                            </div>
